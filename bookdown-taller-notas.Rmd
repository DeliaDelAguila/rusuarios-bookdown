...
- Ventaja: las notas siempre se compilan en un ambiente más fijo que mi máquina local (reproducibilidad). Los estudiantes pueden replicar este flujo de trabajo con sus propios repositorios
